...
router.get('/api/users/dailynorma', authenticate, isValidId, ctrl.getDailyNorma);

router.patch('/api/users/dailynorma', authenticate, isValidId, validBody(schemas.updateDailyNormaSchema), ctrl.updateDailyNorma);
